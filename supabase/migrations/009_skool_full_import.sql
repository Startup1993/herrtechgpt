-- Skool-Import: 19 Module, 197 Lektionen mit Titel + Beschreibung + Wistia-Zuordnung

-- Update module descriptions

-- Replace all module_videos with Skool lesson data
DELETE FROM public.module_videos;

INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'w7vi114g8i', 'Einfach starten - Der rote Faden zum Beginn!', '**Einfach mal machen! 🚀**
...
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'ki2hrtz63s', '01 - KI Marketing Masterclass - Intro', 'Herzlich Willkommen zu meiner 1% KI Marketing Class! 
...
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'pa21so3f93', '02 - Einzigartiges KI Marketing', '', 2, 1016 FROM public.course_modules WHERE slug = 'ki-marketing-course';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'i42d1vzzzg', '03 - Marketing Strategie mit KI', '', 3, 2560 FROM public.course_modules WHERE slug = 'ki-marketing-course';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 's030zb029h', '04 - Deine (KI) Brand', '', 4, 1644 FROM public.course_modules WHERE slug = 'ki-marketing-course';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, '2uva0xd5ks', '05 - Algorithmus verstehen', '', 5, 2743 FROM public.course_modules WHERE slug = 'ki-marketing-course';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'a3bybnadqm', '06 - Das virale Skript und die Hook (!)', '', 6, 2462 FROM public.course_modules WHERE slug = 'ki-marketing-course';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'jwzw3uvjla', 'Bonus: Kreativität finden', '', 7, 996 FROM public.course_modules WHERE slug = 'ki-marketing-course';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'MISSING___', 'Bonus: Die besten Prompts in 2025 🤫', '', 8, 0 FROM public.course_modules WHERE slug = 'ki-marketing-course';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'jjclk7x0iu', 'UPDATE: KI Influencer & Content erstellen 🔥', '', 1, 1978 FROM public.course_modules WHERE slug = 'ki-content-erstellung';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'tyt6fzcazp', 'Sora 2 - konsistente Charaktere erstellen:', '', 2, 717 FROM public.course_modules WHERE slug = 'ki-content-erstellung';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, '1m7921ojri', '01 - Die Vorteile von KI Influencer & KI Content', '', 3, 2208 FROM public.course_modules WHERE slug = 'ki-content-erstellung';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'tetuyp9rci', '02 - KI Influencer & KI Content erstellen', '', 4, 171 FROM public.course_modules WHERE slug = 'ki-content-erstellung';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'areke39nhd', '03- KI Influencer & KI Content erstellen', '', 5, 1472 FROM public.course_modules WHERE slug = 'ki-content-erstellung';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'wyj2q5n3x0', '04 - Die KI Video Generierung', '', 6, 829 FROM public.course_modules WHERE slug = 'ki-content-erstellung';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'a0edyx4px2', '05 - KI Visuals erstellen', '', 7, 694 FROM public.course_modules WHERE slug = 'ki-content-erstellung';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'i26t15dt6t', '06 - Das Drehbuch: KI Storytelling at its finest', '', 8, 2034 FROM public.course_modules WHERE slug = 'ki-content-erstellung';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'fayoax6znl', 'Bonus - KI Musik Intro 🎶', '', 9, 524 FROM public.course_modules WHERE slug = 'ki-content-erstellung';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'MISSING___', 'Bonus - Mit KI Musik viral gehen 🚀', '', 10, 0 FROM public.course_modules WHERE slug = 'ki-content-erstellung';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'wjosmv1n3r', 'Bonus - Before-After Transform Videos erstellen', '', 11, 31 FROM public.course_modules WHERE slug = 'ki-content-erstellung';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, '9gco8pzsnv', 'Bonus - viraler TikTok Trend: süße KI Avatare', '', 12, 424 FROM public.course_modules WHERE slug = 'ki-content-erstellung';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'sfe5dg9v8x', 'Bonus - Immobilienvideos mit KI erstellen 🏠', '# 🏠 Immobilienvideos mit KI erstellen – In 4 einfachen Schritten!
...
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'MISSING___', 'Mini Bonus: Speed Ramp Transitions mit KI 🚤', '', 14, 0 FROM public.course_modules WHERE slug = 'ki-content-erstellung';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'MISSING___', 'Perfekte Seedance 2.0 Prompts ⭐️', 'Seedance 2.0 ist aktuell auf einem komplett anderen Level, wenn es um KI-Videos geht.
...
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'MISSING___', 'Videos von dir in Seedance 2.0?! 🔥', '', 2, 0 FROM public.course_modules WHERE slug = 'seedance';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'MISSING___', 'Meine Top Herr Tech Seedance Prompts 🎨', '', 3, 0 FROM public.course_modules WHERE slug = 'seedance';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'MISSING___', 'Vergiss ChatGPT. Hier kommt Claude.', '', 1, 0 FROM public.course_modules WHERE slug = 'claude';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'zh37bstbuy', 'Claude Code: 🤖 Claude Code aufsetzen', 'Was wäre, wenn Du ab heute keinen Entwickler mehr brauchst – und trotzdem alles bauen kannst, was Du willst? 🤯
...
💥 Den kompletten Guide mit Action-Plan, Prompts zum direkten Loslegen und allen Schritten findet ihr im Anhang. Runterladen. Jetzt. Sofort. 👇', 2, 745 FROM public.course_modules WHERE slug = 'claude';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, '34kt327vre', 'Claude Code: 🔌 CC – Connectors & MCP', '', 3, 645 FROM public.course_modules WHERE slug = 'claude';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'MISSING___', 'Claude Code: 🎬 CC editiert meine Videos', '', 4, 0 FROM public.course_modules WHERE slug = 'claude';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'MISSING___', 'Claude Code: 🎠 KI-Karussell-Generator', '', 5, 0 FROM public.course_modules WHERE slug = 'claude';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'umdsce8iz8', 'Claude Code: 🎬 Herr Tech Video Creator', '', 6, 980 FROM public.course_modules WHERE slug = 'claude';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'MISSING___', 'Claude Cowork: 🖥️ Claude Cowork – Dein persönlicher Agent', '', 7, 0 FROM public.course_modules WHERE slug = 'claude';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'MISSING___', 'Claude Cowork: 🗂️ Claude Cowork + Obsidian', '', 8, 0 FROM public.course_modules WHERE slug = 'claude';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'MISSING___', 'Claude Skills: 🧠 Claude Skills – Einmal kurz erklärt', '', 9, 0 FROM public.course_modules WHERE slug = 'claude';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'MISSING___', 'Claude Skills: 🧡 Flo`s Skills Sammlung', '', 10, 0 FROM public.course_modules WHERE slug = 'claude';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'MISSING___', '00 - Das KI Vertriebs Cheat Sheet 💶🛠️', 'Bevor es ans Eingemachte geht: Hier im **PDF** findest du eine strukturierte Übersicht, wie du dir Schritt für Schritt ein **funktionierendes KI-Vertriebssystem** aufbaust. 💸
...
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'gdtrbk5yxx', '01 - Sales und KI - Einführung', '', 2, 532 FROM public.course_modules WHERE slug = 'ki-vertrieb';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'n38b89ne35', '02 - Laserfokus auf Leadgenerierung', '', 3, 1047 FROM public.course_modules WHERE slug = 'ki-vertrieb';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'vfhrchji80', '03 - Erfolgreiche Telefonakquise', '', 4, 2100 FROM public.course_modules WHERE slug = 'ki-vertrieb';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 't3e52tonut', '04 - E-Mail Marketing Strategien', '', 5, 964 FROM public.course_modules WHERE slug = 'ki-vertrieb';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'tw16uc8zwu', '05 - Kunden finden mit LinkedIn', '', 6, 1302 FROM public.course_modules WHERE slug = 'ki-vertrieb';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'u9yezgzue5', '06 - Daten exportieren mit Phantombuster', '', 7, 671 FROM public.course_modules WHERE slug = 'ki-vertrieb';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'i3li8tgnjr', '07 - Datendownload mit Waalaxy', '', 8, 1128 FROM public.course_modules WHERE slug = 'ki-vertrieb';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, '44ckq7qzac', '08 - Vergleich von E-Mail-Finder-Tools', '', 9, 1443 FROM public.course_modules WHERE slug = 'ki-vertrieb';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'rzmxuzkdhv', '09 - E-Mail-Akquise mit Reply IO und Valaxie', '', 10, 1439 FROM public.course_modules WHERE slug = 'ki-vertrieb';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'lub9pu6wam', '10 - Strategien für Kaltakquise auf Linkedin', '', 11, 1157 FROM public.course_modules WHERE slug = 'ki-vertrieb';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'lec0lvmtgt', '11 - Strategien für erfolgreiche Kampagnen', '', 12, 1253 FROM public.course_modules WHERE slug = 'ki-vertrieb';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, '5x4uo1da2m', '12 - Trigify', '', 13, 346 FROM public.course_modules WHERE slug = 'ki-vertrieb';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'dhjm7i4sec', '13 - Kunden überzeugen', '', 14, 2536 FROM public.course_modules WHERE slug = 'ki-vertrieb';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'k27rvc9455', '14 - Den Sack zumachen', '', 15, 1872 FROM public.course_modules WHERE slug = 'ki-vertrieb';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'MISSING___', '15 - Das Sales Funnel Cheat Sheet', '', 16, 0 FROM public.course_modules WHERE slug = 'ki-vertrieb';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'pcei207wk4', 'Das Wundertool Fonio', '## 📞 *„Nie wieder selber ans Telefon!“*
...
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'plll1dyhji', 'Plattform Tutorial mit Daniel', '', 2, 174 FROM public.course_modules WHERE slug = 'ki-telefonie';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, '3thohhw2iw', 'Rechtliche Grenzen von KI', '', 1, 861 FROM public.course_modules WHERE slug = 'rechtliche-grenzen';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'hili1jsgvo', 'Viralen Content finden & Content Automatisierung', '**🧠 *****1. Die Content-Krise: Warum die meisten keine Relevanz aufbauen***
...
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, '8ftb0fko2h', 'Viral gehen mit Veo3 🥳', '', 1, 1719 FROM public.course_modules WHERE slug = 'veo3';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, '28ru5k53qu', 'Perfekter Veo3 Content durch Prompting', '# Veo3 Prompting Masterclass
...
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'nlxer2t5ot', 'Der 5-Minuten-Produktions-Workflow', '', 3, 890 FROM public.course_modules WHERE slug = 'veo3';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'f33ulzue83', 'Lipsync mit VEO3 – sprechende KI Influencer', '', 4, 779 FROM public.course_modules WHERE slug = 'veo3';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, '039tbiqxpg', 'Viral gehen mit Sora 2', '', 1, 635 FROM public.course_modules WHERE slug = 'sora-2';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'yecbgy7vn7', 'SETUP Tutorial: Sora 2 mit eigenem Gesicht nutzen', '# **🚀 So könnt ihr SORA2 mit eurem eigenen Gesicht nutzen (Cameo Funktion) – Das Setup Tutorial**
...
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'MISSING___', 'SORA 2 Wasserzeichen Entfernen: Alle Methoden 🤩', '', 3, 0 FROM public.course_modules WHERE slug = 'sora-2';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'tyt6fzcazp', 'Konsistente Charaktere in SORA 2 erstellen:', '', 4, 717 FROM public.course_modules WHERE slug = 'sora-2';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'jm86ytfwdb', 'KI Agenten & Business Automatisierung Part 1', '', 1, 2228 FROM public.course_modules WHERE slug = 'ki-agenten';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'MISSING___', 'Deine 1. 5 KI Mitarbeiter - in Minuten erstellt 🤯', '', 2, 0 FROM public.course_modules WHERE slug = 'ki-agenten';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'l8oz23u62i', 'ChatGPT Atlas: Lektion 1: Atlas Setup & die ersten 3 Use Cases', '', 3, 503 FROM public.course_modules WHERE slug = 'ki-agenten';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, '4lgvr6myev', 'ChatGPT Atlas: Lektion 2: Trends, Profil & Lead-Generierung', '', 4, 318 FROM public.course_modules WHERE slug = 'ki-agenten';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'v2uohx4zm7', 'ChatGPT Atlas: Lektion 3: Agent Mode & Fortgeschrittene Use Cases', '', 5, 436 FROM public.course_modules WHERE slug = 'ki-agenten';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'MISSING___', 'Guides: Der ultimative Einsteiger-Guide für n8n', '', 6, 0 FROM public.course_modules WHERE slug = 'ki-agenten';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'MISSING___', 'Guides: In 30 Tagen zum KI-Agenten-Profi', '', 7, 0 FROM public.course_modules WHERE slug = 'ki-agenten';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'MISSING___', 'Guides: 30-Tage KI-Plan für Selbstständige & Agenturen', '', 8, 0 FROM public.course_modules WHERE slug = 'ki-agenten';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'MISSING___', 'Guides: Deine persönlichen Automations-Coaches', '', 9, 0 FROM public.course_modules WHERE slug = 'ki-agenten';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'bd7oyb4m0x', 'n8n Automatisierung: Segment 1: Was dich erwartet', '', 10, 127 FROM public.course_modules WHERE slug = 'ki-agenten';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'dvodawl23s', 'n8n Automatisierung: Segment 2: Was du lernen wirst', '', 11, 41 FROM public.course_modules WHERE slug = 'ki-agenten';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'e7drmae081', 'n8n Automatisierung: Segment 3: Wieso n8n verwenden', '', 12, 160 FROM public.course_modules WHERE slug = 'ki-agenten';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'wd2k0ztden', 'n8n Automatisierung: Segment 4: Wie n8n verwenden', '', 13, 120 FROM public.course_modules WHERE slug = 'ki-agenten';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'ih927w1zul', 'n8n Automatisierung: Segment 5: n8n Hacks', '', 14, 61 FROM public.course_modules WHERE slug = 'ki-agenten';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, '36atozxjnb', 'n8n Automatisierung: Segment 6: Tutorial – Newsletter Ideensammler', '', 15, 413 FROM public.course_modules WHERE slug = 'ki-agenten';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, '86gxudamoe', 'n8n Automatisierung: Segment 7: Outro & Community', '', 16, 63 FROM public.course_modules WHERE slug = 'ki-agenten';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'MISSING___', 'n8n Automatisierung: 2000+ n8n Automationen - Die Workflow Sammlung', '', 17, 0 FROM public.course_modules WHERE slug = 'ki-agenten';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'ziqf43kiav', 'n8n Automatisierung: Tutorial: n8n Veo3 Video Agent', '', 18, 1067 FROM public.course_modules WHERE slug = 'ki-agenten';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'edznz6ge0t', 'n8n Automatisierung: Tutorial: n8n Kaltakquise auf Autopilot', '', 19, 1464 FROM public.course_modules WHERE slug = 'ki-agenten';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'f455gpiks5', 'n8n Automatisierung: Tutorial: Automated Social-Media Product-Content', '', 20, 1365 FROM public.course_modules WHERE slug = 'ki-agenten';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'npx2e6vx6p', 'n8n Automatisierung: Tutorial: Automated Selfie-Video Content', '⚠️ Warnung: Das ist das komplizierteste Kapitel in diesem Classroom! Zunächst bitte in die anderen n8n Kapitel einarbeiten. Sobald du alle 7 Intro-Segmente der n8n Automatisierung und am besten noch ein paar einfache Workflows umgesetzt hast, bist du READY FÜR DIESES KAPITEL! 🤩
...
**🚀 Let’s Go!**', 21, 1120 FROM public.course_modules WHERE slug = 'ki-agenten';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, '9fjx7g6n7b', 'make Automatisierung: Einstieg in die Automatisierung mit Make 🔥', '', 22, 801 FROM public.course_modules WHERE slug = 'ki-agenten';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'omi393rvzf', 'make Automatisierung: Vollautomatisierter Social Media Account 🤯', '', 23, 668 FROM public.course_modules WHERE slug = 'ki-agenten';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'x81z0t7crv', 'make Automatisierung: Vollautomatisierte Social Media Videos 🎬', '', 24, 893 FROM public.course_modules WHERE slug = 'ki-agenten';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, '79edhvakor', 'make Automatisierung: 100% Automatisierter Youtube Kanal mit KI', '', 25, 1166 FROM public.course_modules WHERE slug = 'ki-agenten';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'bnizatosm1', 'make Automatisierung: Automatische Lead-Verarbeitung', '', 26, 1173 FROM public.course_modules WHERE slug = 'ki-agenten';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'plofhshwli', 'Die Prompt Bibel', '# Download --> Scrolle runter
...
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'MISSING___', '1. So nutzt du dieses Playbook', '', 2, 0 FROM public.course_modules WHERE slug = 'prompt-legende';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'MISSING___', '2. Quickstart: In 3 Minuten zum Output', '', 3, 0 FROM public.course_modules WHERE slug = 'prompt-legende';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'MISSING___', '3. R.I.D.E. Framework', '', 4, 0 FROM public.course_modules WHERE slug = 'prompt-legende';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'MISSING___', '4. Der Herr Tech-Universalprompt', '', 5, 0 FROM public.course_modules WHERE slug = 'prompt-legende';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'MISSING___', '5. Die Prompt-Bibliothek', '', 6, 0 FROM public.course_modules WHERE slug = 'prompt-legende';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'MISSING___', '6. Von Prompts zur Skalierung', '', 7, 0 FROM public.course_modules WHERE slug = 'prompt-legende';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'MISSING___', 'Bonus 1: Prompts für KI Avatare', '', 8, 0 FROM public.course_modules WHERE slug = 'prompt-legende';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'MISSING___', 'Bonus 2: Blogprompt für SEO-Rankings', '', 9, 0 FROM public.course_modules WHERE slug = 'prompt-legende';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'MISSING___', 'Bonus 3: ChatGPT richtig füttern', '', 10, 0 FROM public.course_modules WHERE slug = 'prompt-legende';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'MISSING___', 'ChatGPT ist komplett verwirrt? 😵‍💫--> Neuer Chat', '', 11, 0 FROM public.course_modules WHERE slug = 'prompt-legende';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'MISSING___', 'Wieder direkte Antworten von ChatGPT bekommen!', '', 12, 0 FROM public.course_modules WHERE slug = 'prompt-legende';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'MISSING___', 'Der Prompt Engineering Guide von Google 🤩', '', 13, 0 FROM public.course_modules WHERE slug = 'prompt-legende';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'de9ktjd2eb', 'KI SEO', '# 🚀 SEO-Automatisierung mit KI - Game Changer Alert!
...
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'pse5r148cs', 'Das KI Toolboard 🦾', '**DAS HERR TECH KI TOOLBOARD**
...
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'bbzobtprbs', 'Kapitel 0: Super viral mit KI Musik 🤖🎶', '## **⚠️ Bevor ihr in die Erstellung von KI Musik geht, unbedingt anschauen! ⚠️**
...
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'dzwstl5i8o', 'Kapitel 1: Einführung und Texterstellung 🚀', '', 2, 782 FROM public.course_modules WHERE slug = 'ki-musik';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'arkbwj1rse', 'Kapitel 2: Rap und erste Schritte mit Suno AI 🎤', '', 3, 817 FROM public.course_modules WHERE slug = 'ki-musik';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'iaqdvaxzqr', 'Kapitel 3: House Music für die nächste Party 🏠', '', 4, 1387 FROM public.course_modules WHERE slug = 'ki-musik';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, '5gf0ptjht3', 'Kapitel 4 - Schlager - Ein Song für Mutti 💝', '', 5, 629 FROM public.course_modules WHERE slug = 'ki-musik';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'e4kgecifxs', 'Kapitel 5 - Kurze Songs für Social Media 📱', '', 6, 882 FROM public.course_modules WHERE slug = 'ki-musik';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'xnsx919zgf', 'Bonus Kapitel - Swing und Jazz 🎷', '', 7, 337 FROM public.course_modules WHERE slug = 'ki-musik';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'w2wnsiuqca', 'Kapitel 1 - KI Monetarisierung 🏦', '## 🎯 Das große Ziel: Finanzielle Freiheit durch KI-Automatisierung
...
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'MISSING___', 'tiktok Shop/Instagram Leitfaden 🦾💸', '', 2, 0 FROM public.course_modules WHERE slug = 'passives-einkommen';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'MISSING___', 'Intro in Prompting und die besten Prompts 🦾', '', 1, 0 FROM public.course_modules WHERE slug = 'community';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'xv5p3k5f86', 'Sprechende KI Videos in Minuten - free!', '', 2, 50 FROM public.course_modules WHERE slug = 'community';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'eoowp03rev', 'GPTs erstellen & damit Geld verdienen', '', 3, 1489 FROM public.course_modules WHERE slug = 'community';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'MISSING___', 'KI Toolboard: Die wichtigsten KI Tools für euch', '', 4, 0 FROM public.course_modules WHERE slug = 'community';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'huz1e7ikia', 'Aufzeichnung 1. Live Call 🦾', '', 1, 9395 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'k9hjh38x2r', 'Aufzeichnung 2. Live Call 🦾', '', 2, 7184 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'bfu37cyi1q', 'Aufzeichnung KI Automatisierung Live Call', '', 3, 7500 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, '09ufhuvn7x', 'Aufzeichnung - Start doing 🦾', '', 4, 8288 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'te2txrvc3j', 'Content Explosion Call mit Patrick 🔥', '', 5, 7465 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'i4ylzupbqk', 'KI Vertriebs Call mit Steffen 🤩', '', 6, 6631 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'v3v4968jzs', 'Roasting & DOING!', '', 7, 6782 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'd84n3xb68b', 'Die Hook 🪝', '', 8, 6227 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'qa17gob1di', 'Live Call - Das virale Skript 🎥', '', 9, 8040 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, '9h9srpllzi', 'Live Call - KI Telefonie', '', 10, 4356 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'vsmporm6lb', 'Live Call Roasting & Strategy', '', 11, 5036 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, '83wdm5ns53', 'Live Call - KI Klone & Avatare', '', 12, 11426 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'vdv1y9cyyb', 'Live Call - Monetarisierung', '', 13, 8066 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'v113faclea', 'Live Call KI Mail Outbound', '', 14, 8102 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'tpuu1n65h7', 'Live Call - No Excuses!', '', 15, 5693 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'o6bl0lg02j', 'Live Call - KI Strategie', '', 16, 8758 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'gejb8dm04e', 'Live Call - KI Agenten, Make.com & n8n Einstieg', '', 17, 6108 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'mc1x0y5bh2', 'Live Call - die Hook', '', 18, 7159 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'x9abyhr3hq', 'Live Call - Viral gehen', '', 19, 8077 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'mtiv4m4utg', 'Live Call - KI Telefonie', '', 20, 3979 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'lq7qtfqdnx', 'Live Call - Sales Funnel', '', 21, 4302 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'pfw5yuq5za', 'Live Call - Unique KI Content & KI Influencer', '', 22, 8785 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'su8dctvvr7', 'Live Call - Passives Einkommen mit KI', '', 23, 5769 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, '0aoy40t20r', 'Live Call - Mail Outbound mit KI', '', 24, 3357 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'u91f1tkbfc', 'Live Call - Autom.-Agentur Aufbau mit Felix', '', 25, 4689 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'tnsbjxxjkt', 'Live Call - Content Q&A mit Patrick 🎨', '', 26, 7923 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'l39m8pyav8', 'Live Call - KI & Recht mit Boris', '', 27, 5420 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, '0vaua8z7s3', 'Live Call - Viral gehen mit KI - Mr. Techno', '', 28, 7051 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'key46z7be7', 'Live Call - KI Musik mit Steffen', '', 29, 5171 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'yts79obeu8', 'Live Call - Community Aufbau mit Mr. Skool', '', 30, 5994 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'i02youkxnt', 'Live Call -  Viral mit Veo3', '', 31, 3613 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, '8m3fqp5uvl', 'Live Call - Von der Kaltakquise bis zum Lead', '', 32, 4916 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'mzj4r2ke3c', 'Live Call - KI Strategie', '', 33, 6635 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 't6hqoqniw5', 'Live Call - Viral gehen / Account roasting', '', 34, 10168 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, '8u6805wyxt', 'Live Call - KI Agentur Aufbau mit Felix', '', 35, 5348 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, '5danrtwgdh', 'Live Call - Passives Einkommen mit KI', '', 36, 7538 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'm6p8u4w0py', 'Live Call - Content mit Veo 3', '', 37, 5224 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'mwucztdexr', 'Live Call - Account/Business Model Roasting', '', 38, 10470 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'dmvcykoevx', 'Live Call - KI Vertrieb mit Steffen', '', 39, 7472 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, '9c3hsglgyp', 'Live Call - KI Vision 2025', '', 40, 7954 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, '9cctf6juz0', 'Live Call - Der perfekte Sales Funnel', '', 41, 5407 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'MISSING___', 'Live Call - Ultra viral gehen', '', 42, 0 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'MISSING___', 'Live Call - KI Content Erstellung (inkl. SORA)', '', 43, 0 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, '4g9xcuz3mx', 'Live Call - KI Musik 07.11.', '', 44, 4132 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'fonz4sc9ff', 'Live Call - KI Vertrieb Automatisierung 12.11.', '', 45, 4516 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'zoaqzumgja', 'Live Call - Automatisierung KI Agenten 13.11.2025', '', 46, 4972 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'p37t2t3ljd', 'Live Call - Content & Account Roasting 18.11.2025', '', 47, 6730 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'y0on6z0sr5', 'Live Call - Community Business aufbauen 20.11.2025', '', 48, 3750 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'q0fixcj78b', 'Live Call - KI & Recht 24.11.2025', '', 49, 6038 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'iazgeoejv3', 'Live Call - KI Vision & Strategie 28.11.2025', '', 50, 8253 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'cvlnu9gf6n', 'Live Call - Super viral mit KI 01.12.2025', '', 51, 8250 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, '4pwi2tr905', 'Live Call - Sales Funnel 04.12.2025', '', 52, 8810 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'yjk7wlmbbj', 'Live Call - KI Content Erstellung 10.12.2025', '', 53, 10485 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, '39ysd9oqyl', 'Live Call - Passives Einkommen mit KI 12.12.2025', '', 54, 11188 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 's0hps33db6', 'Live Call - KI Telefonie 15.12.2025', '', 55, 4582 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'bgldj8xxu3', 'Live Call - KI Agenten 18.12.2025', '', 56, 5152 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'wf0wvbujn4', 'Live Call - Linkedin Automation - 22.12.2025', '', 57, 5039 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'phd1ub2f7f', 'Live Call -  Linkedin Viral 08.01.2026', '', 58, 7411 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, '2myw5jzv6m', 'Live Call - Musik Promotion 21.01.2026', '', 59, 5074 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'pztnd2tukw', 'Live Call - Ads 26.01.2026', '', 60, 6217 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'eazt0guklj', 'Live Call - Sales Funnel 29.01.2026', '', 61, 5386 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'p5y87enjxl', 'Live Call - KI Vision 02.02.2026', '', 62, 6406 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'i6ts7va5ti', 'Live Call - KI Content Erstellung 05.02.2026', '', 63, 8746 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, '9etgvd0qoz', 'Live Call - Super viral mit KI 10.02.2026', '', 64, 8314 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, '7o1hr71xft', 'Live Call - KI Vertrieb 13.02.2026', '', 65, 3706 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'snux31ipzf', 'Live Call - KI Agenten 16.02.2026', '', 66, 7879 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, '8tf3dcbonp', 'Live Call - Passives Einkommen 18.02.2026', '', 67, 6439 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'j7elvsaa54', 'Live Spezial - Franz Wegener 23.02.2026', '', 68, 5252 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'pmxmu5bzrc', 'Live Call - KI Automation mit Felix 04.03.2026', '', 69, 4341 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'p12l0miawe', 'Live Call - KI Vision 10.03.2026', '', 70, 7297 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'qoqr1lbbwv', 'Live Call - KI Content 12.03.2026', '', 71, 28747 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, '82xjtfitj7', 'Live Call - Sales Funnel KI 17.03.2026', '', 72, 4557 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'g3l3w59mkh', 'Live Call - Viral mit KI 19.03.2026', '', 73, 8788 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, '59gdjkhb0e', 'Live Call - Calvin Hollywood 23.03.2026', '', 74, 4496 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'tv91fv728v', 'Live Call - KI Automatisierung 25.03.2026', '', 75, 5991 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'w2oo2he5jp', 'Live Call - Sarah Rojewski 31.03.2026', '', 76, 4693 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'uwfb4li1oa', 'Live Call - Passives Einkommen mit KI 01.04.2026', '', 77, 5756 FROM public.course_modules WHERE slug = 'live-calls';
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, '3yxgro99be', 'Live Call - KI Plattform 08.04.2026', '## **🛠️ KI Plattform bauen & vermarkten – Live-Call Zusammenfassung**
...
INSERT INTO public.module_videos (module_id, wistia_hashed_id, title, description, sort_order, duration_seconds) SELECT id, 'ggv8iduiif', 'Live Call - KI Vision 16.04.2026', '', 79, 8745 FROM public.course_modules WHERE slug = 'live-calls';

-- 197 lessons total, 39 without wistia_id