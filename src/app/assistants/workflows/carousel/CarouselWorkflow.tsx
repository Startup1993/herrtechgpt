    ...
    <div className="max-w-3xl mx-auto px-8 pt-8 pb-24">
      ...
      <div className="flex items-center justify-between mb-5 flex-wrap gap-3">
        <div>
          ...
          <p className="text-sm text-muted">{slides.length} Slides · Klick auf Text zum Bearbeiten</p>
        </div>
      ...
      {/* Edit hint */}
      <div className="flex items-center gap-2 mb-4 px-3 py-2 bg-primary/5 border border-primary/15 rounded-lg text-xs text-primary">
        <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg>
        Texte direkt auf dem Slide anklicken und bearbeiten — dann einfach downloaden
      </div>
